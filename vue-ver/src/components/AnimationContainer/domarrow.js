...
function changedConnectedTag(changes) {
  console.log("chagnedConnectedTag")
  changes.forEach(e => {
...
function changedConnectionTag(changes) {
  console.log("changedConnectionTag")
  changes.forEach(e => {
    var conn = e.target;
...
exports.repaintConnection = repaintConnection
exports.repaintWithoutObserve = repaintWithoutObserve